...
function calcTotalPrice(cart) {
  ...
  cart.cartItem.forEach((element) => {
    ...
    var itemDiscount = totalPrice - ((totalPrice * element.totalProductDiscount) / 100)
    discountPrice += totalPrice -  itemDiscount
  });
  ...
  if (cart.discount) {
    ...
    cart.totalPriceAfterDiscount -
      (cart.totalPriceAfterDiscount * cart.discount) / 100;
  }
}
